...
class RunState:
    ...
    def summary(self) -> List[str]:
        ...
        if abs(self.ghost_speed_factor - 1.0) > 0.01:
            out.append(
                f"Ghost speed: x{1.0 / self.ghost_speed_factor:.2f}")
...
PAIRS: List[Dict] = [
    {  # 1. Pac-Man speed.
        "bonus": {"label": "Pac-Man FASTER",
                  "field": "pac_speed_factor", "op": "mul", "value": 0.85,
                  "min": 0.4},
        "malus": {"label": "Pac-Man SLOWER",
